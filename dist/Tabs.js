import { defineComponent as G, ref as I, onMounted as X, onBeforeUnmount as Z, watch as J, createVNode as b, Teleport as Q, resolveComponent as ee, openBlock as h, createElementBlock as C, createElementVNode as N, normalizeClass as k, Fragment as D, renderList as P, withDirectives as x, createBlock as te, withCtx as Y, withModifiers as S, toDisplayString as V, vShow as L, createTextVNode as ne, renderSlot as F, createCommentVNode as le } from "vue";
function R(e) {
...
const $ = "div", ue = /* @__PURE__ */ G({
  ...
  setup(e, {
    ...
    function m() {
      var u, c, E;
      const s = ((u = r.value) == null ? void 0 : u.querySelector('[data-role="trigger"]')) || ((c = r.value) == null ? void 0 : c.querySelector(".dropdown-toggle")) || ((E = r.value) == null ? void 0 : E.firstElementChild);
    ...
    return X(() => {
      m(), a.value && (T(a.value, p.CLICK, y), T(a.value, p.KEY_DOWN, d)), T(l.value, p.KEY_DOWN, d), T(window, p.CLICK, w), T(window, p.TOUCH_END, w), e.modelValue && y(!0);
    }), Z(() => {
...
function ve(e, n, t, o, a, l) {
  const r = ee("dropdown");
  return h(), C("section", null, [
    N("ul", {
      class: k(l.navClasses),
      role: "tablist"
    }, [
      (h(!0), C(D, null, P(l.groupedTabs, (i, d) => (h(), C(D, { key: d }, [
        i.tabs ? x((h(), te(r, {
          key: 0,
          role: "presentation",
          tag: "li",
          ...
          dropdown: Y(() => [
            (h(!0), C(D, null, P(i.tabs, (m, y) => x((h(), C("li", {
              key: `${d}_${y}`,
              class: k(l.getTabClasses(m, !0))
            }, [
              N("a", {
                href: "#",
                onClick: S((w) => l.select(a.tabs.indexOf(m)), ["prevent"])
              }, V(m.title), 9, fe)
            ], 2)), [
              [L, !m.hidden]
            ])), 128))
          ...
          i.$slots.title ? (h(), C("a", {
            ...
            role: "tab",
            href: "#",
            onClick: S((m) => l.select(a.tabs.indexOf(i)), ["prevent"])
          }, null, 8, he)) : (h(), C("a", {
            key: 1,
            role: "tab",
            href: "#",
      ...
      !t.justified && e.$slots["nav-right"] ? (h(), C("li", ge, [
        F(e.$slots, "nav-right")
      ])) : le("", !0)
    ], 2),
    N("div", {
...
const me = /* @__PURE__ */ re(ce, [["render", ve]]);
export {
  me as default
};
