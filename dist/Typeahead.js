...
function w(e, s, t) {
  e == null || e.addEventListener(s, t);
}
function S(e, s, t) {
  e == null || e.removeEventListener(s, t);
}
function $(e) {
...
const q = "div", ce = /* @__PURE__ */ X({
  ...
  setup(e, {
        ...
        if (y === 27)
          ...
          if (!O)
            ...
            for (let m = 0; m < p.length; m++)
              if (O === p[m]) {
                y === 38 && m < p.length > 0 ? P(p[m - 1]) : y === 40 && m < p.length - 1 && P(p[m + 1]);
                break;
              }
        }
      }
    ...
    function K() {
      var i, d, E;
      const u = ((i = a.value) == null ? void 0 : i.querySelector('[data-role="trigger"]')) || ((d = a.value) == null ? void 0 : d.querySelector(".dropdown-toggle")) || ((E = a.value) == null ? void 0 : E.firstElementChild);
    ...
    function B(u) {
      ...
      if (v.value && i) {
        ...
        const p = (E = o.value) == null ? void 0 : E.contains(i), m = ((y = a.value) == null ? void 0 : y.contains(i)) && !p, L = p && u.type === "touchend";
        !m && !O && !L && T(!1);
      }
    }
    return z(() => {
  ...
  setup(e, { emit: s }) {
    ...
    R(
      ...
      await M(), E(t.target), y(), T = K.value.$el.querySelector(".dropdown-menu"), t.modelValue && i(t.modelValue);
    }), G(() => {
      O();
    });
    function i(l) {
    ...
    function L() {
      ...
      m(l, t.debounce), s("update:modelValue", t.forceSelect ? void 0 : l);
    }
    function b() {
      if (t.openOnFocus) {
        const l = n.value.value;
