...
function T(e, t, n) {
  e == null || e.removeEventListener(t, n);
}
function re(e) {
...
const R = "div", ae = /* @__PURE__ */ z({
  ...
  setup(e, {
    ...
    function m(r) {
      ...
      if (i.value) {
        ...
        if (O === 27)
          ...
          const x = o(), g = S.querySelectorAll("li:not(.disabled) > a");
          if (!x)
            L(g[0]);
          else
    ...
    function w() {
      var a, c, S;
      const r = ((a = u.value) == null ? void 0 : a.querySelector('[data-role="trigger"]')) || ((c = u.value) == null ? void 0 : c.querySelector(".dropdown-toggle")) || ((S = u.value) == null ? void 0 : S.firstElementChild);
    ...
    function d(r) {
      ...
      if (i.value && a) {
        ...
        const g = (S = l.value) == null ? void 0 : S.contains(a), b = ((O = u.value) == null ? void 0 : O.contains(a)) && !g, _ = g && r.type === "touchend";
        !b && !x && !_ && C(!1);
      }
    }
    return G(() => {
...
}, pe = ["disabled"], he = /* @__PURE__ */ E("div", {
  class: "pull-right",
  style: { display: "inline-block", "vertical-align": "middle" }
}, [
  /* @__PURE__ */ E("span", null, " "),
  /* @__PURE__ */ E("span", { class: "caret" })
], -1), me = ["textContent"], ge = {
  key: 0,
      ...
      (f(!0), h(N, null, F(l.groupedOptions, (o, m) => (f(), h(N, null, [
        ...
        (f(!0), h(N, null, F(o.options, (w, C) => (f(), h("li", {
          ...
          l.customOptionsVisible ? (f(), h("a", Oe, [
            ...
            E("b", null, D(w[n.labelKey]), 1),
            n.selectedIcon ? (f(), h("span", {
              key: 0,
              class: k(l.selectedIconClasses)
            }, null, 2)) : K("", !0)
          ])) : (f(), h("a", Ce, [
            E("span", null, D(w[n.labelKey]), 1)
          ]))
        ], 42, we))), 128))
      ], 64))), 256))
    ]),
...
const xe = /* @__PURE__ */ ce(fe, [["render", Ee]]);
export {
  xe as default
};
